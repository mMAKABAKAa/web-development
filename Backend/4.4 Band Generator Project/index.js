...
app.post("/submit", (req, res) => {
  ...
  let adjNum=Math.floor(adj.length*Math.random());
  let nounNum=Math.floor(noun.length*Math.random());
  let generateName=adj[adjNum]+' '+noun[nounNum];
  res.render("index.ejs",{name:generateName})
});
